...
def get_config():
    ...
    training.ref_model_path = "runs/edm_cifar10_improved"
    ...
    training.loss_norm = "huber"
    training.finetune = False
    training.stopgrad = True
    training.dsm_target = True
    training.solver = "euler"
    training.start_ema = 0.0
    training.start_scales = 2
    training.end_scales = 1280
    training.target_ema_mode = "improved"
    training.scale_mode = "improved"
    training.weighting = "improved"
    training.index_distribution = "improved"
